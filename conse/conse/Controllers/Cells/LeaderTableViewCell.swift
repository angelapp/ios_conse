...
class LeaderTableViewCell: UITableViewCell, UITextFieldDelegate, WKNavigationDelegate {
    ...
    func fillLeader04() {
        ...
        btn_Aud1.tag = AUDIO_ID.AUD_3.rawValue
        btn_Aud2.tag = AUDIO_ID.AUD_4.rawValue
        btn_Aud3.tag = AUDIO_ID.AUD_5.rawValue
        btn_Aud4.tag = AUDIO_ID.AUD_6.rawValue
    ...
    func fillLeader05() {
        ...
        btn_Aud1.isSelected = false
        btn_Aud1.tag = AUDIO_ID.AUD_7.rawValue
    ...
    func fillLeader07() {
        ...
        btn_Aud1.tag = AUDIO_ID.AUD_8.rawValue
        btn_Aud2.tag = AUDIO_ID.AUD_9.rawValue
        btn_Aud3.tag = AUDIO_ID.AUD_10.rawValue
    ...
    func fillLeader14() {
        ...
        btn_Aud1.tag = AUDIO_ID.AUD_11.rawValue
        btn_Aud2.tag = AUDIO_ID.AUD_12.rawValue
    ...
    @IBAction func playAudio(_ sender: UIButton) {
        ...
        case AUDIO_ID.AUD_1.rawValue:
            leadersDelegate?.audioManager(audioID: .AUD_1, play: sender.isSelected)
            break
            
        case AUDIO_ID.AUD_2.rawValue:
            leadersDelegate?.audioManager(audioID: .AUD_2, play: sender.isSelected)
            break
            
        default:
            leadersDelegate?.audioManager(audioID: .AUD_3, play: sender.isSelected)
            break
        }
